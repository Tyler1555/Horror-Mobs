...
public class ModelShadowLurker extends ModelBase
{
  //fields
    ModelRenderer Head;
    ModelRenderer Body;
  ...
  public ModelShadowLurker()
  {
    ...
    textureHeight = 32;
      ...
      Head.setRotationPoint(0F, 15F, -11F);
      ...
      setRotation(RightArm, -0.4461411F, 0F, 0F);
      //LeftArm.mirror = true;
      ...
      LeftArm.mirror = true;
      setRotation(LeftArm, -0.4461433F, 0F, 0F);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
  {
	  ...
	  this.RightLeg.rotationPointY = 9.0F + var7;
      this.LeftLeg.rotationPointY = 9.0F + var7;
